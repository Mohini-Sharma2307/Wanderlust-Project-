...
const cityCoords = {
  ...
  Aspen: [-106.821, 39.1911],
  Florence: [11.2558, 43.7696],
  Portland: [-122.6765, 45.5231],
  Cancun: [-86.8515, 21.1619],
  "Lake Tahoe": [-120.043, 39.0968],
  "Los Angeles": [-118.2437, 34.0522],
  Verbier: [7.2261, 46.0966],
  "Serengeti National Park": [34.6857, -2.3333],
  Amsterdam: [4.9041, 52.3676],
  Fiji: [178.065, -17.7134],
  Cotswolds: [-1.7495, 51.8336],
  Boston: [-71.0589, 42.3601],
  Bali: [115.1889, -8.4095],
  Banff: [-115.5722, 51.1784],
  Miami: [-80.1918, 25.7617],
  Phuket: [98.3963, 7.8804],
  "Scottish Highlands": [-4.2026, 57.4778],
  Dubai: [55.2708, 25.2048],
  Montana: [-109.837, 46.8797],
  Mykonos: [25.3909, 37.4467],
...
const listingsWithGeometry = sampleListings.map(listing => ({
  ...
  geometry: {
    type: "Point",
    coordinates: cityCoords[listing.location] || [0, 0] // fallback if city not found
  }
}));
